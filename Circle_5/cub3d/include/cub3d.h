...
#define WIN_W 2560
#define WIN_H 1440
#define MINI_PIXEL_CELL 10 // pixel per cella della minimappa
#define MINI_SIZE 6 // quante celle si vedono attorno al player
...
void		my_mlx_pixel_put(t_game *g, t_data *data, int x, int y, int color);
